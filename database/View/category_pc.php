...
<section id="category" class="py-3">
    <div class="container">
        <h4 class="font-rubik font-size-20">Category PC</h4>
        <hr>
        <div class="button-group text-right font-baloo font-size-16" id="filters">
            ...
            <button class="btn btn-isotop" data-filter=".Lenovo">Lenovo</button>
            <button class="btn btn-isotop" data-filter=".Acer">Acer</button>
            <button class="btn btn-isotop" data-filter=".Hp">Hp</button>
        </div>
        <div class="grid text-center">
            <?php foreach ($showPcLenovo as $key => $value) { ?>
                <div class="grid-item Lenovo col-3">
            ...
            <?php } ?>
            <?php foreach ($showPcAcer as $key => $value) { ?>
                <div class="grid-item Acer col-3">
            ...
            <?php } ?>
            <?php foreach ($showPcHp as $key => $value) { ?>
                <div class="grid-item Hp col-3">
                    <form action="" method="post" class="">
                        <div class="item py-2">
                            <div class="product font-raleway">
                                <a href="#"><img src="<?= $value['image_product']; ?>" alt="product1" class="img-fluid img-thumbnail"></a>
